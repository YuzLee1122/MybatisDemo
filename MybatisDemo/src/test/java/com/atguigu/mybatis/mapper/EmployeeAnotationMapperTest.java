 ...
 *                  不能作为静态属性，或普通属性
 */
public class EmployeeAnotationMapperTest
{
    ...
    public void getAll() {
        ...
        try {
            ...
            // class com.sun.proxy.$Proxy5 implements EmployeeAnotationMapper
            EmployeeAnotationMapper mapper = session.getMapper(EmployeeAnotationMapper.class);
            // com.sun.proxy.$Proxy5
            System.out.println(mapper.getClass().getName());

            Class<?>[] interfaces = mapper.getClass().getInterfaces();
            for (Class<?> anInterface : interfaces) {
                //interface com.atguigu.mybatis.mapper.EmployeeAnotationMapper
    ...
    public void getEmployeeById() {
        ...
        try {
            ...
            System.out.println(mapper.getEmployeeById(4));
